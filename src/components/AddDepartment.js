                          ...
                          <div className="row">
                            <div className="col-12">
                              <div className="form-group has-icon-left">
                                <label htmlFor="first-name-icon">Department Short Name</label>
                            ...
                            <div className="col-12">
                              <div className="form-group has-icon-left">
                                <label htmlFor="email-id-icon">Department Name</label>
                                <div className="position-relative">
                                  <input type="text" className="form-control" placeholder="Input Department Name" id="email-id-icon" />
                                  <div className="form-control-icon">
                                    <i className="fa fa-table"></i>
                                  </div>
                                </div>
